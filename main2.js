...
const clients = new Collection([
  [
    'peter', // key
    {
      ...
      prefix: '-',
      token: 'NzY2NzQ4NjIwNzE1ODUxODI5.X4n4TA.gn61WnEGTc15Usu3wf44Byerntc',
    },
  ],
  [
    'ayse', // second key
    {
      ...
      prefix: '?',
      token: 'NzY2NzgwOTE2NDc5Mjk1NTI5.X4oWYA.AxVxOQ5Kz_IVHEkg6QhpxK53nVY',
    },
  ],
]);
...
require('./welcome')(clients.first().client); // execute the welcome function
// no need to make this a variable as you're only using it once
clients.first().client.on('message', async (msg) => {
